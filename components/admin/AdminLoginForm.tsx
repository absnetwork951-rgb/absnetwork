    ...
    <div className="min-h-screen bg-[#0B0F14] text-slate-100 flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10 space-y-8">
        ...
        <div className="bg-[#0F141C] border border-[#1E293B] rounded-2xl p-8 shadow-2xl space-y-6">
          {errorMsg && (
            <div role="alert" className="p-4 bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs flex items-center gap-2 animate-in fade-in rounded-xl">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <span id="password-visibility-hint" className="sr-only">
                  {showPassword ? 'Master password is currently visible.' : 'Master password is currently hidden.'}
                </span>
              </div>
            </div>
